...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'CHK_ITEMMASTSTK
        '
        Me.CHK_ITEMMASTSTK.BackgroundImage = CType(resources.GetObject("CHK_ITEMMASTSTK.BackgroundImage"), System.Drawing.Image)
        ...
        'CHK_ABC
        '
        Me.CHK_ABC.BackgroundImage = CType(resources.GetObject("CHK_ABC.BackgroundImage"), System.Drawing.Image)
        Me.CHK_ABC.Font = New System.Drawing.Font("Microsoft Sans Serif", 9.75!, System.Drawing.FontStyle.Bold)
        Me.CHK_ABC.Location = New System.Drawing.Point(856, 632)
        Me.CHK_ABC.Name = "CHK_ABC"
        Me.CHK_ABC.Size = New System.Drawing.Size(128, 24)
        Me.CHK_ABC.TabIndex = 497
        Me.CHK_ABC.Text = "ABC ANALYSIS"
        Me.CHK_ABC.Visible = False
        '
        'CHECK1
        '
        ...
        Me.Chk_SelectAllSubgroup.Location = New System.Drawing.Point(376, 49)
        ...
        Me.Chklist_SubGroup.Location = New System.Drawing.Point(376, 97)
        Me.Chklist_SubGroup.Name = "Chklist_SubGroup"
        Me.Chklist_SubGroup.Size = New System.Drawing.Size(264, 151)
        ...
        Me.Label7.Location = New System.Drawing.Point(376, 285)
        ...
        Me.Select_AllComp.Location = New System.Drawing.Point(376, 261)
        Me.Select_AllComp.Name = "Select_AllComp"
        Me.Select_AllComp.Size = New System.Drawing.Size(128, 24)
        ...
        Me.Chklist_Company.Location = New System.Drawing.Point(376, 309)
        Me.Chklist_Company.Name = "Chklist_Company"
        Me.Chklist_Company.Size = New System.Drawing.Size(264, 151)
    ...
    Public Sub ViewStocksummary()
        Try
            ...
            Else
                ...
                sqlstring = " update INVENTORYITEMMASTER SET SELECTOPT='N' WHERE ITEMCODE NOT IN(" & SLSTRING & ") and storecode='" & Storecode & "'"
                gconnection.getDataSet(sqlstring, "ITEMMASTER1")

                sqlstring = " update INVENTORYITEMMASTER SET SELECTOPT='Y' WHERE ITEMCODE IN(" & SLSTRING & ")and storecode='" & Storecode & "'"
            ...
            End If
            sqlstring = sqlstring & " GROUP BY S.ITEMCODE ,S.ITEMNAME,ISNULL(S.UOM,''), I.GROUPNAME,ISNULL(I.SUBGROUPNAME,''),ISNULL(CONVALUE,1) ORDER BY I.GROUPNAME "
    ...
    Private Sub StkSummary_crystal()
        Try
            ...
            If CHK_ZEROQTY.Checked = False Then
                sqlstring = sqlstring & " And (OPQTY <> 0 OR RCVQTY <> 0 OR ISSQTY <> 0)"
            End If
            sqlstring = sqlstring & " GROUP BY ISNULL(S.ITEMCODE,''),ISNULL(S.ITEMNAME,''),ISNULL(S.UOM,''), ISNULL(I.GROUPNAME,'') , ISNULL(S.ISSRATE,0) , ISNULL(S.RCVRATE,0) ORDER BY  "
            If rdo_code.Checked = True Then
