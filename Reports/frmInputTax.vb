...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents chklst_storelocation As System.Windows.Forms.CheckedListBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.chklst_storelocation = New System.Windows.Forms.CheckedListBox
        ...
        Me.lbl_Heading.Location = New System.Drawing.Point(480, 16)
        ...
        Me.frmbut.Size = New System.Drawing.Size(984, 56)
        ...
        Me.chklst_Credit.Location = New System.Drawing.Point(16, 104)
        Me.chklst_Credit.Name = "chklst_Credit"
        Me.chklst_Credit.Size = New System.Drawing.Size(328, 319)
        ...
        Me.GroupBox3.Size = New System.Drawing.Size(976, 64)
        ...
        Me.grp_SalebillChecklist.Location = New System.Drawing.Point(128, 0)
        ...
        Me.dtp_Fromdate.Location = New System.Drawing.Point(328, 24)
        ...
        Me.Label6.Location = New System.Drawing.Point(544, 28)
        ...
        Me.dtp_Todate.Location = New System.Drawing.Point(648, 24)
        ...
        Me.Label5.Location = New System.Drawing.Point(232, 648)
        Me.Label5.Name = "Label5"
        Me.Label5.Size = New System.Drawing.Size(655, 21)
        Me.Label5.TabIndex = 426
        Me.Label5.Text = "Press F2 to Search Credit Ledger/ Press F3 to Search Debit Ledger / Press ENTER k" & _
        "ey to navigate"
        '
        'Timer1
        '
        ...
        Me.Chk_SelectAllDebit.Location = New System.Drawing.Point(368, 48)
        ...
        Me.chklst_Debit.Location = New System.Drawing.Point(368, 104)
        Me.chklst_Debit.Name = "chklst_Debit"
        Me.chklst_Debit.Size = New System.Drawing.Size(328, 319)
        ...
        Me.txt_Vat.Location = New System.Drawing.Point(504, 448)
        ...
        Me.lbl_Vat.Location = New System.Drawing.Point(376, 450)
        ...
        Me.Cmd_Print.Location = New System.Drawing.Point(560, 600)
        Me.Cmd_Print.Name = "Cmd_Print"
        Me.Cmd_Print.Size = New System.Drawing.Size(104, 32)
        Me.Cmd_Print.TabIndex = 449
        ...
        Me.Cmd_View.Location = New System.Drawing.Point(416, 600)
        Me.Cmd_View.Name = "Cmd_View"
        Me.Cmd_View.Size = New System.Drawing.Size(104, 32)
        Me.Cmd_View.TabIndex = 447
        ...
        Me.Cmd_Exit.Location = New System.Drawing.Point(712, 600)
        ...
        Me.Cmd_Clear.Location = New System.Drawing.Point(272, 600)
        Me.Cmd_Clear.Name = "Cmd_Clear"
        Me.Cmd_Clear.Size = New System.Drawing.Size(104, 32)
        Me.Cmd_Clear.TabIndex = 446
        ...
        Me.Label3.Location = New System.Drawing.Point(720, 80)
        Me.Label3.Name = "Label3"
        Me.Label3.Size = New System.Drawing.Size(280, 24)
        Me.Label3.TabIndex = 451
        Me.Label3.Text = "STORE LOCATION:"
        '
        'chklst_storelocation
        '
        Me.chklst_storelocation.Font = New System.Drawing.Font("Times New Roman", 12.0!, System.Drawing.FontStyle.Bold)
        Me.chklst_storelocation.Location = New System.Drawing.Point(720, 104)
        Me.chklst_storelocation.Name = "chklst_storelocation"
        Me.chklst_storelocation.Size = New System.Drawing.Size(280, 319)
        Me.chklst_storelocation.TabIndex = 450
        '
        'Chk_SelectAllStore
        '
        ...
        Me.Controls.Add(Me.chklst_storelocation)
...
#End Region
    ...
    Private Sub inputtax_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Try
            ...
            ElseIf e.KeyCode = Keys.F1 Then
                ...
                Asearch.chklistbox = chklst_Credit
                Asearch.Text = "Advanced Search Credit"
                Asearch.ShowDialog(Me)
            ElseIf e.KeyCode = Keys.F2 Then
                Dim search As New frmListSearch
                search.listbox = chklst_Credit
                search.Text = "Credit Search"
                search.ShowDialog(Me)
            ElseIf e.KeyCode = Keys.F3 Then
                Dim search As New frmListSearch
                search.listbox = chklst_Debit
                search.Text = "Debit Search"
                search.ShowDialog(Me)
            End If
    ...
    Private Sub Viewsuppliernamewise1()
        Try
            ...
            If chklst_storelocation.CheckedItems.Count <> 0 Then
                sqlstring = sqlstring & "  AND STOREDESC IN ("
                For i = 0 To chklst_storelocation.CheckedItems.Count - 1
                    sqlstring = sqlstring & " '" & Trim(chklst_storelocation.CheckedItems(i)) & "', "
                Next
                sqlstring = Mid(sqlstring, 1, Len(sqlstring) - 2)
    ...
    Private Sub Timer1_Tick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        Try
            If Me.ProgressBar1.Value > 0 And Me.ProgressBar1.Value < 15 Then
    ...
    Private Sub Fillcredit()
        Try
            ...
            sqlstring = "SELECT SLCODE,SLNAME FROM accountssubledgermaster WHERE ISNULL(FREEZEFLAG,'')<>'Y' AND ACCODE IN (SELECT ACCODE FROM ACCOUNTSGLACCOUNTMASTER WHERE ISNULL(acCODE,'')='" & Trim(gCreditors) & "') order by SLCODE "
    ...
    Private Sub FillDEBIT()
        Try
            ...
            sqlstring = "SELECT accode,acdesc FROM accountsglaccountmaster WHERE ISNULL(FREEZEFLAG,'')<>'Y' ORDER BY ACCODE "
            gconnection.getDataSet(sqlstring, "accountsglaccountmaster")
            If gdataset.Tables("accountsglaccountmaster").Rows.Count - 1 >= 0 Then
                For i = 0 To gdataset.Tables("accountsglaccountmaster").Rows.Count - 1
                    With gdataset.Tables("accountsglaccountmaster").Rows(i)
    ...
    Private Sub FillSTORELOCATION()
        Try
            Dim i As Integer
            chklst_storelocation.Items.Clear()
            sqlstring = "SELECT ISNULL(STOREDESC,'') STOREDESC FROM STOREMASTER WHERE ISNULL(FREEZE,'')<>'Y' ORDER BY STOREDESC "
            gconnection.getDataSet(sqlstring, "FILLSTORELOCATION")
            If gdataset.Tables("FILLSTORELOCATION").Rows.Count - 1 >= 0 Then
                For i = 0 To gdataset.Tables("FILLSTORELOCATION").Rows.Count - 1
                    With gdataset.Tables("FILLSTORELOCATION").Rows(i)
                        chklst_storelocation.Items.Add(Trim(.Item("STOREDESC")))
                    End With
                Next i
            End If
        Catch ex As Exception
    ...
    Private Sub Chk_SelectAllStore_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Chk_SelectAllStore.CheckedChanged
        Try
            ...
            If Chk_SelectAllStore.Checked = True Then
                For i = 0 To chklst_storelocation.Items.Count - 1
                    chklst_storelocation.SetItemChecked(i, True)
                Next
            Else
                For i = 0 To chklst_storelocation.Items.Count - 1
                    chklst_storelocation.SetItemChecked(i, False)
                Next
            End If
        Catch ex As Exception
            MessageBox.Show("Plz Check Error : " & ex.Message, MyCompanyName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1)
