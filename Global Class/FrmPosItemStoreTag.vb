...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmPosItemStoreTag))
        ...
        Me.lbl_Heading.Size = New System.Drawing.Size(227, 24)
...
#End Region
    ...
    Private Sub FrmPosItemStoreTag_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i, j As Integer
        SQLSTRING = "SELECT ISNULL(P.POS,'') AS POS,ISNULL(P.ITEMCODE,'') AS ITEMCODE,ISNULL(K.STORECODE,'') AS STORECODE FROM POSMENULINK P LEFT OUTER JOIN POSITEMSTORELINK K ON K.POS = P.Pos AND K.ITEMCODE = P.ItemCode  ORDER BY STORECODE,P.Pos,P.ItemCode"
