...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmstockissuerate))
    ...
    Private Sub Cmd_UPDATE_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_UPDATE.Click
        ...
        If mm = 0 Then
            ...
            If chk_issue.Checked = True Then
                ...
                sqlstring = "SELECT * FROM STOCKISSUEDETAIL WHERE ISNULL(VOID,'')<>'Y' AND ITEMCODE = '0268' AND CAST(CONVERT(VARCHAR(11),DOCDATE,6) AS DATETIME) BETWEEN '" & Format(dtp_FROMdate.Value, "dd-MMM-yyyy") & "' AND '" & Format(dtp_TOdate.Value, "dd-MMM-yyyy") & "' ORDER BY AUTOID"
                gconnection.getDataSet(sqlstring, "ISSUE")
                If gdataset.Tables.Contains("ISSUE") Then
                    If gdataset.Tables("ISSUE").Rows.Count > 0 Then
                        PBAR.Maximum = gdataset.Tables("ISSUE").Rows.Count
