...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(sub_Sub_Group_Master))
        ...
        Me.lbl_Heading.Location = New System.Drawing.Point(184, 8)
        Me.lbl_Heading.Name = "lbl_Heading"
        Me.lbl_Heading.Size = New System.Drawing.Size(324, 31)
        ...
        Me.txt_GroupDesc.Location = New System.Drawing.Point(264, 96)
        ...
        Me.txt_GroupCode.Location = New System.Drawing.Point(264, 64)
        ...
        Me.lbl_GroupDescription.Location = New System.Drawing.Point(56, 96)
        Me.lbl_GroupDescription.Name = "lbl_GroupDescription"
        Me.lbl_GroupDescription.Size = New System.Drawing.Size(193, 18)
        ...
        Me.lbl_GroupCode.Location = New System.Drawing.Point(112, 64)
        Me.lbl_GroupCode.Name = "lbl_GroupCode"
        Me.lbl_GroupCode.Size = New System.Drawing.Size(139, 18)
        ...
        Me.frmbut.Location = New System.Drawing.Point(8, 328)
        ...
        Me.cmdGroupCode.Location = New System.Drawing.Point(456, 64)
        ...
        Me.lbl_Freeze.Location = New System.Drawing.Point(208, 304)
        ...
        Me.ssgrid.Size = New System.Drawing.Size(504, 160)
        ...
        Me.Cmd_Exit.Location = New System.Drawing.Point(480, 344)
        ...
        Me.Cmd_View.Location = New System.Drawing.Point(368, 344)
...
#End Region
        ...
        Try
            ...
            If Cmd_Add.Text = "Add [F7]" Then
                ...
                For i = 1 To ssgrid.DataRowCnt
                    With ssgrid
                        ...
                        .Row = i
                        If Trim(.Text) <> "" Then
                            strSQL = " INSERT INTO inventorysubsubgroupmaster (Groupcode,Groupdesc,Subgroupcode,Subgroupdesc,Freeze,Adduser,Adddate)"
            ...
            ElseIf Cmd_Add.Text = "Update[F7]" Then
                ...
                If Mid(Me.Cmd_Add.Text, 1, 1) = "U" Then
                    ...
                    End If
                End If
                strSQL = strSQL & " DELETE FROM inventorysubsubgroupmaster WHERE Groupcode='" & Trim(txt_GroupCode.Text) & "'"
                ReDim Preserve Insert(Insert.Length)
                Insert(Insert.Length - 1) = strSQL
                For i = 1 To ssgrid.DataRowCnt
                    With ssgrid
    ...
    Private Sub cmdGroupCode_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGroupCode.Click
        Try
            ...
            vform.vFormatstring = "       SUBGROUP CODE     |         SUBGROUP DESCRIPTION                             "
    ...
    Private Sub txt_GroupCode_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_GroupCode.Validated
        Try
            Dim j As Integer
            If Trim(txt_GroupCode.Text) <> "" Then
                sqlstring = "SELECT * FROM inventorySUBsubgroupmaster WHERE Groupcode='" & Trim(txt_GroupCode.Text) & "'"
                ...
                If gdataset.Tables("inventorysubsubgroupmaster").Rows.Count > 0 Then
                    txt_GroupDesc.Text = Trim(gdataset.Tables("inventorysubsubgroupmaster").Rows(0).Item("Groupdesc"))
                    With ssgrid
                        For i = 1 To gdataset.Tables("inventorysubsubgroupmaster").Rows.Count
                            .SetText(1, i, Trim(gdataset.Tables("inventorysubsubgroupmaster").Rows(j).Item("Subgroupcode")) & "")
                            .SetText(2, i, Trim(gdataset.Tables("inventorysubsubgroupmaster").Rows(j).Item("Subgroupdesc")) & "")
                            j = j + 1
                        Next
                    End With
                    If gdataset.Tables("inventorysubsubgroupmaster").Rows(0).Item("Freeze") = "Y" Then
                        ...
                        Me.lbl_Freeze.Text = ""
                        Me.lbl_Freeze.Text = "Record Freezed  On " & Format(CDate(gdataset.Tables("inventorysubsubgroupmaster").Rows(0).Item("AddDate")), "dd-MMM-yyyy")
