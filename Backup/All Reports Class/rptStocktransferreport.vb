...
Public Class rptStockTransferreport
        ...
        Try
            ...
            For Each dr In gdataset.Tables("Stockissuereport").Rows
                ...
                If docno <> dr("docdetails") Then
                    ...
                    pagesize = pagesize + 1
                    printline = ""
                    printline = vsubheader(0) & Trim(dr("docdetails"))
                    ...
                    printline = printline & vsubheader(3) & Trim(dr("FROMSTOREdesc"))
                    Filewrite.WriteLine(printline)
                    pagesize = pagesize + 1
                    Filewrite.WriteLine()
                    pagesize = pagesize + 1

                    printline = vsubheader(4) & Trim(dr("TOSTORECODE"))
                    printline = printline & Space(84 - (Trim(dr("TOSTORECODE")).Length + Len(vsubheader(4))))
    ...
    Private Function Print_Headers(ByVal pageheading() As String)
        ...
        Dim head As String = "STORE TRANSFER"
        Dim x As String
        pagesize = 0
        Try
