...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.ChkLst_Group.Size = New System.Drawing.Size(288, 130)
        ...
        Me.CHK_BILLNO.Location = New System.Drawing.Point(880, 616)
        Me.CHK_BILLNO.Name = "CHK_BILLNO"
        Me.CHK_BILLNO.Size = New System.Drawing.Size(104, 32)
        ...
        Me.Label9.Location = New System.Drawing.Point(304, 275)
        ...
        Me.Chk_SelectAllSubgroup.Location = New System.Drawing.Point(304, 252)
        ...
        Me.Chklist_SubGroup.Location = New System.Drawing.Point(304, 299)
        Me.Chklist_SubGroup.Name = "Chklist_SubGroup"
        Me.Chklist_SubGroup.Size = New System.Drawing.Size(280, 172)
        ...
        Try
            ...
            If CHK_ITEM.Checked = False Then
                If opt_Purchasesummary.Checked = True Then
                    ...
                    sqlstring = " select distinct  grndetails , grndate,pono ,Supplierinvno, suppliercode , suppliername , sum(totalamount) as totalamount , sum(vatamount)as vatamount ,surchargeamt as surchargeamt , sum(discountamount) as discountamount , billamount as billamount,OVERALLDISCOUNT , DISCOUNT,sum(SGSTAMT) as SGSTAMT,sum( CGSTAMT)as CGSTAMT,sum(IGSTAMT) as IGSTAMT,sum(AMOUNT) as AMOUNT,sum(OTHCHARGE)as OTHCHARGE,podate from viewpurchaseregistersummary "
                    If chklst_Supplier.CheckedItems.Count <> 0 Then
                    ...
                    sqlstring = sqlstring & " group by grndetails , grndate,pono ,Supplierinvno, suppliercode , suppliername,OVERALLDISCOUNT , DISCOUNT,surchargeamt,billamount,podate"
            ...
            ElseIf CHK_ITEM.Checked = True Then
                If opt_Purchasedetails.Checked = True Then
                    ...
                    Else
                        Me.Cursor = Cursors.WaitCursor
                        Dim v As New Rpt_PurRegister_Item1
                        gconnection.getDataSet(sqlstring, "viewpurchaseregistersummary")
                        If gdataset.Tables("viewpurchaseregistersummary").Rows.Count > 0 Then
                ...
                ElseIf opt_Purchasesummary.Checked = True Then
                    ...
                    sqlstring = " SELECT pono,Supplierinvno,podate, suppliername,ITEMCODE,ITEMNAME,uom,SUM(qty) AS QTY,(SUM(AMOUNT)/SUM(qty)) AS RATE,SUM(AMOUNT) AS AMOUNT,SUM(TAXAMOUNT) AS TAXAMOUNT, "
                    sqlstring = sqlstring & " SUM(DISCOUNT) AS DISCOUNT , SUM(OTHCHARGE) AS OTHCHARGE,SUM(OVERALLDISCOUNT) AS OVERALLDISCOUNT,sum(DISCOUNT) as DISCOUNT,sum(SGSTAMT) as SGSTAMT,sum(CGSTAMT) as CGSTAMT,sum(IGSTAMT) as IGSTAMT,sum(AMOUNT) as AMOUNT,sum(OTHCHARGE)as OTHCHARGE FROM VIEWPURCHASEREGISTERSUMMARY "
                    If chklst_Supplier.CheckedItems.Count <> 0 Then
                        sqlstring = sqlstring & " WHERE SUPPLIERCODE IN ("
                        For i = 0 To chklst_Supplier.CheckedItems.Count - 1
                            SUPPLIERNAME = Split(chklst_Supplier.CheckedItems(i), "-->")
                    ...
                    sqlstring = sqlstring & " AND GRNDATE BETWEEN"
                    sqlstring = sqlstring & " '" & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "' AND ' " & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "'"
                    sqlstring = sqlstring & " GROUP BY ITEMCODE,ITEMNAME,pono,Supplierinvno,podate, suppliername,uom "
