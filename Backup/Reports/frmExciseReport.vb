...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Compiler As System.Windows.Forms.CheckBox
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Compiler = New System.Windows.Forms.CheckBox
        ...
        Me.lbl_Heading.Location = New System.Drawing.Point(464, 16)
        Me.lbl_Heading.Name = "lbl_Heading"
        Me.lbl_Heading.Size = New System.Drawing.Size(156, 31)
        Me.lbl_Heading.TabIndex = 5
        Me.lbl_Heading.Text = "Excise Report"
        ...
        Me.lbl_GroupList.Size = New System.Drawing.Size(304, 16)
        ...
        Me.Chklist_Groupdesc.Size = New System.Drawing.Size(304, 214)
        ...
        Me.CHK_ZEROQTY.Location = New System.Drawing.Point(856, 600)
        ...
        Me.CHK_VALUE.Location = New System.Drawing.Point(856, 568)
        ...
        Me.CHK_ITEMMASTSTK.Location = New System.Drawing.Point(856, 528)
        ...
        Me.CHK_ABC.Location = New System.Drawing.Point(856, 648)
        Me.CHK_ABC.Name = "CHK_ABC"
        Me.CHK_ABC.Size = New System.Drawing.Size(128, 24)
        Me.CHK_ABC.TabIndex = 497
        Me.CHK_ABC.Text = "WITH VALUE"
        '
        'CHECK1
        '
        Me.CHECK1.Location = New System.Drawing.Point(976, 672)
        Me.CHECK1.Name = "CHECK1"
        Me.CHECK1.Size = New System.Drawing.Size(32, 24)
        Me.CHECK1.TabIndex = 498
        ...
        Me.Label6.Size = New System.Drawing.Size(264, 24)
        Me.Label6.TabIndex = 501
        Me.Label6.Text = "SELECT SUBGROUP :"
        '
        ...
        Me.Chklist_SubGroup.Location = New System.Drawing.Point(376, 96)
        Me.Chklist_SubGroup.Name = "Chklist_SubGroup"
        Me.Chklist_SubGroup.Size = New System.Drawing.Size(264, 361)
        Me.Chklist_SubGroup.TabIndex = 500
        '
        'Label7
        '
        ...
        'Select_AllComp
        '
        Me.Select_AllComp.BackColor = System.Drawing.Color.Transparent
        Me.Select_AllComp.Font = New System.Drawing.Font("Microsoft Sans Serif", 9.75!, System.Drawing.FontStyle.Bold)
        Me.Select_AllComp.Location = New System.Drawing.Point(40, 320)
        Me.Select_AllComp.Name = "Select_AllComp"
        Me.Select_AllComp.Size = New System.Drawing.Size(128, 16)
        Me.Select_AllComp.TabIndex = 502
        Me.Select_AllComp.Text = "SELECT ALL"
        '
        'Chklist_Company
        '
        Me.Chklist_Company.CheckOnClick = True
        Me.Chklist_Company.Font = New System.Drawing.Font("Times New Roman", 12.0!, System.Drawing.FontStyle.Bold)
        Me.Chklist_Company.Location = New System.Drawing.Point(40, 368)
        Me.Chklist_Company.Name = "Chklist_Company"
        Me.Chklist_Company.Size = New System.Drawing.Size(264, 130)
        Me.Chklist_Company.TabIndex = 503
        '
        'Compiler
        '
        Me.Compiler.Font = New System.Drawing.Font("Microsoft Sans Serif", 9.75!, System.Drawing.FontStyle.Bold)
        Me.Compiler.Location = New System.Drawing.Point(856, 528)
        Me.Compiler.Name = "Compiler"
        Me.Compiler.Size = New System.Drawing.Size(152, 32)
        Me.Compiler.TabIndex = 505
        Me.Compiler.Text = "Excise Compiler Report"
        '
        'frmExciseReport
        '
        ...
        Me.ControlBox = False
        Me.Controls.Add(Me.Compiler)
        Me.Controls.Add(Me.Label7)
        Me.Controls.Add(Me.Select_AllComp)
        Me.Controls.Add(Me.Chklist_Company)
        ...
        Me.KeyPreview = True
        Me.Name = "frmExciseReport"
        Me.Text = "REPORTS [EXCISE REPORT]"
...
#End Region
    ...
    Private Sub FillItemdetails()
        ...
        End If
    End Sub
    Private Sub FillSubGroupdetails()
        Dim i, J As Integer
        Dim sqlstring, ssql As String
        ssql = ""
        sqlstring = "select distinct subgroupname from inventoryitemmaster where ISNULL(subgroupname,'')  <>'' and ISNULL(Freeze,'')<>'Y' order by subgroupname"
        ...
        If gdataset.Tables("INVENTORYSUBGROUPMASTER").Rows.Count > 0 Then
            ...
            For i = 0 To gdataset.Tables("INVENTORYSUBGROUPMASTER").Rows.Count - 1
                With gdataset.Tables("INVENTORYSUBGROUPMASTER").Rows(i)
                    Chklist_SubGroup.Items.Add(Trim(CStr(.Item("subgroupname"))))
                End With
            Next i
        End If
    ...
    Private Sub FillGroupdetails()
        ...
        sqlstring = "SELECT ISNULL(GROUPCODE,'') AS GROUPCODE,ISNULL(GROUPDESC,'') AS GROUPDESC FROM INVENTORYGROUPMASTER ORDER BY GROUPCODE,GROUPDESC"
        ...
        End If
    End Sub
    Private Sub FillCompanypdetails()
        Dim i As Integer
        Dim sqlstring As String
        Chklist_Company.Items.Clear()
        'sqlstring = "SELECT ISNULL(GROUPCODE,'') AS GROUPCODE,ISNULL(GROUPNAME,'') AS GROUPDESC FROM INVENTORYITEMMASTER WHERE STORECODE='" & Trim(TXT_MAINSTORECODE.Text) & "' GROUP BY GROUPCODE,GROUPNAME"
        sqlstring = "SELECT ISNULL(COMPANYCODE,'') AS COMPANYCODE,ISNULL(COMPANYNAME,'') AS COMPANYNAME FROM INVENTORYCOMPANYMASTER ORDER BY COMPANYCODE,COMPANYNAME"
        gconnection.getDataSet(sqlstring, "INVENTORYCOMPANYMASTER")
        If gdataset.Tables("INVENTORYCOMPANYMASTER").Rows.Count - 1 >= 0 Then
            For i = 0 To gdataset.Tables("INVENTORYCOMPANYMASTER").Rows.Count - 1
                With gdataset.Tables("INVENTORYCOMPANYMASTER").Rows(i)
                    Chklist_Company.Items.Add(Trim(.Item("COMPANYCODE") & "-->" & .Item("COMPANYNAME")))
                End With
            Next
        End If
    End Sub
    Private Sub Cmd_View_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_View.Click
        If TXT_FROM.Text = "" And txt_itemto.Text = "" Then
            If Trim(TXT_FROM.Text) = "" And Trim(txt_itemto.Text) = "" Then
                If Chklist_SubGroup.CheckedItems.Count = 0 Then
                    MessageBox.Show("Select the Sub Group description(s)", MyCompanyName, MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Exit Sub
                End If
        ...
        Else
            ...
            If MsgBox("Click YES for 'Windows View' or NO for 'TEXT View'", MsgBoxStyle.YesNo, "STOCK SUMMARY") = MsgBoxResult.Yes Then
                ...
                ElseIf CHK_VALUE.Checked = True Then
                    Call StkSummary_crystal_wv()
                ElseIf Compiler.Checked = True Then
                    Call ExciseCompilerReport_crystal()
                End If
            Else
                If CHK_ITEMMASTSTK.Checked = True Then
    ...
    Public Sub ViewStocksummary()
        Try
            Dim Clsquantity, Itemcode(), CompCode(), Itemcode1, Update(0), Storecode As String
            ...
            Else
                ...
                SLSTRING = ""
                For I = 0 To Chklist_SubGroup.CheckedItems.Count - 1
                    Itemcode = Split(Chklist_SubGroup.CheckedItems(I), "-->")
                    SLSTRING = SLSTRING & "'" & Itemcode(0) & "', "
                Next
                SLSTRING = Mid(SLSTRING, 1, Len(SLSTRING) - 2)

                sqlstring = " update INVENTORYITEMMASTER SET SELECTOPT='N' WHERE subgroupname NOT IN(" & SLSTRING & ") and storecode='" & Trim(TXT_MAINSTORECODE.Text) & "'"
                gconnection.getDataSet(sqlstring, "ITEMMASTER1")

                sqlstring = " update INVENTORYITEMMASTER SET SELECTOPT='Y' WHERE subgroupname IN(" & SLSTRING & ")and storecode='" & Trim(TXT_MAINSTORECODE.Text) & "'"
            ...
            sqlstring = " SELECT ISNULL(S.ITEMCODE,'') AS ITEMCODE,ISNULL(S.ITEMNAME,'') AS ITEMDESC,ISNULL(S.UOM,'') AS UOM, ISNULL(I.GROUPNAME,'') AS GROUPNAME,ISNULL(I.SUBGROUPNAME,'') AS SUBGROUPNAME,ISNULL(CONVALUE,1) AS CONVALUE, "
            ...
            'PSTRING = ""
            'For I = 0 To Chklist_Company.CheckedItems.Count - 1
            '    CompCode = Split(Chklist_Company.CheckedItems(I), "-->")
            '    PSTRING = PSTRING & "'" & CompCode(0) & "', "
            'Next
            'If Chklist_Company.CheckedItems.Count > 0 Then
            '    PSTRING = Mid(PSTRING, 1, Len(PSTRING) - 2)
            '    sqlstring = sqlstring & " AND I.COMPANYCODE IN (" & PSTRING & ") "
            'End If
            ...
            sqlstring = sqlstring & " GROUP BY S.ITEMCODE ,S.ITEMNAME,ISNULL(S.UOM,''), I.GROUPNAME,ISNULL(I.SUBGROUPNAME,''),ISNULL(CONVALUE,1) ORDER BY I.GROUPNAME,I.SUBGROUPNAME "
            ...
            Dim heading() As String = {" EXCISE REPORT "}
    ...
    Private Sub ExciseCompilerReport_crystal()
        Try
            Dim str, MTYPE(), tspilt(), ExicesUOM As String
            Dim i As Integer
            Dim rViewer As New Viewer
            Dim r As New Rpt_ExciseReportCompiler
            ...
            sqlstring = "IF NOT EXISTS( SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'INV_LINKSETUP' ) Begin CREATE TABLE INV_LINKSETUP (EXCISEREPORTUOM VARCHAR(20)) End"
            ...
            Else
                ...
                sqlstring = " update INVENTORYITEMMASTER SET SELECTOPT='N' WHERE Itemcode NOT IN(" & SLSTRING & ") and storecode='" & Trim(TXT_MAINSTORECODE.Text) & "'"
                gconnection.getDataSet(sqlstring, "ITEMMASTER1")

                sqlstring = " update INVENTORYITEMMASTER SET SELECTOPT='Y' WHERE Itemcode IN(" & SLSTRING & ") and storecode='" & Trim(TXT_MAINSTORECODE.Text) & "'"
                gconnection.getDataSet(sqlstring, "ITEMMASTER")
            ...
            sqlstring = "select distinct stockuom from InventoryItemMaster where   SELECTOPT='Y' and storecode='" & Trim(TXT_MAINSTORECODE.Text) & "' and isnull(FREEZE,'')<>'Y' and stockuom+'" & ExicesUOM & "' not in ( select BASEUOM+transUOM from INVENTORY_TRANSCONVERSION where ISNULL(freeze,'')<>'Y') "
            gconnection.getDataSet(sqlstring, "INV_LINKSETUP")
            If gdataset.Tables("INV_LINKSETUP").Rows.Count > 0 Then

       
                For i = 0 To gdataset.Tables("INV_LINKSETUP").Rows.Count - 1
            ...
            sqlstring = " exec CP_Inv_Exise "

            gconnection.ExcuteStoreProcedure(sqlstring)

            sqlstring = "UPDATE Inv_ExiseRpt SET priority=0"
            gconnection.ExcuteStoreProcedure(sqlstring)
            sqlstring = "UPDATE Inv_ExiseRpt SET priority=1 WHERE GROUPNAME='TOTAL'"
            ...
            sqlstring = " select * from Inv_ExiseRpt order by PRIORITY ,GROUPNAME,SUBGROUPNAME"
            ...
            If gdataset.Tables("Inv_ExiseRpt").Rows.Count > 0 Then
                ...
                textobj1.Text = "THE CALCUTTA SWIMMING CLUB"   'MyCompanyName
                ...
                textobj8 = r.ReportDefinition.ReportObjects("Text24")
                textobj8.Text = " Store : " + Trim(txt_Mainstore.Text) + " (IN BULK " + ExicesUOM + ")"
    ...
    Private Sub StkSummary_crystal()
        Try
            ...
            sqlstring = " exec CP_Inv_Exise_ITEMConv "
            gconnection.ExcuteStoreProcedure(sqlstring)



            sqlstring = " SELECT ISNULL(S.ITEMCODE,'') AS ITEMCODE,ISNULL(S.ITEMNAME,'') AS ITEMNAME,ISNULL(S.UOM,'') AS UOM, ISNULL(I.subgroupname,'') AS subgroupname, ISNULL(I.groupname,'') AS groupname,"
            ...
            sqlstring = sqlstring & " WHERE I.ITEMCODE=S.ITEMCODE and s.storecode=i.storecode"
            If CHK_ZEROQTY.Checked = False Then
                sqlstring = sqlstring & " And (OPQTY <> 0 OR RCVQTY <> 0 OR ISSQTY <> 0)"
            End If
            sqlstring = sqlstring & " GROUP BY ISNULL(S.ITEMCODE,''),ISNULL(S.ITEMNAME,''),ISNULL(S.UOM,''), ISNULL(I.subgroupname,'') , ISNULL(I.groupname,'') , ISNULL(S.ISSRATE,0) , ISNULL(S.RCVRATE,0) ORDER BY  "
            If rdo_code.Checked = True Then
            ...
            If gdataset.Tables("ISSUEREGISTER").Rows.Count > 0 Then
                ...
                textobj8.Text = Trim(txt_Mainstore.Text)
        ...
        End Try
    End Sub
    Private Sub StkSummary_crystal_wv()
        Try
            Dim str, MTYPE(), tspilt() As String
            Dim i As Integer
            Dim rViewer As New Viewer
            Dim r As New Rpt_ExciseReportWV
            Dim Heading(0) As String
            Dim sqlstring, SSQL As String
            ...
            sqlstring = "  SELECT distinct ISNULL(UOM,'') AS UOM,ISNULL(RUOM,'') AS RUOM FROM  ITEMS WHERE ISNULL(CONV,0) =0  "
            gconnection.getDataSet(sqlstring, "ITEMS")
            If gdataset.Tables("ITEMS").Rows.Count > 0 Then

                Dim stockuom, ExicesUOM As String
                For i = 0 To gdataset.Tables("ITEMS").Rows.Count - 1

                    stockuom = Trim(gdataset.Tables("ITEMS").Rows(i).Item("UOM"))
                    ExicesUOM = Trim(gdataset.Tables("ITEMS").Rows(i).Item("RUOM"))
            ...
            sqlstring = " update STOCKSUMMARY set Itemname= alias, Uom=s.ruom ,Opqty=OPqty*conv ,Rcvqty=Rcvqty*conv,Rcvrate=Rcvrate/conv, Issqty=Issqty*conv,	Issrate=Issrate/conv,Clsqty=Clsqty*conv,	Clsrate=Clsrate/conv,DISPQTY=DISPQTY*conv from STOCKSUMMARY r inner join   Items s on r.Itemcode=s.Itemcode WHERE  ISNULL(S.CONV,0)<>0 "
            gconnection.ExcuteStoreProcedure(sqlstring)


            sqlstring = " SELECT ISNULL(S.ITEMNAME,'') AS ITEMNAME,ISNULL(S.UOM,'') AS UOM, ISNULL(I.subgroupname,'') AS subgroupname, ISNULL(I.groupname,'') AS groupname,"
            sqlstring = sqlstring & "SUM(ISNULL(S.OPQTY,0.000)) AS OPQTY,SUM(ISNULL(S.OPVAL,0.000)) AS OPVAL, SUM(ISNULL(S.RCVQTY,0.000)) AS RCVQTY,SUM(ISNULL(S.RCVVAL,0.000)) AS RCVVAL,SUM(ISNULL(S.RCVQTY1,0.000)) AS RCVQTY1,SUM(ISNULL(S.RCVVAL1,0.000)) AS RCVVAL1,SUM(ISNULL(S.RCVQTY2,0.000)) AS RCVQTY2,SUM(ISNULL(S.RCVVAL2,0.000)) AS RCVVAL2,SUM(ISNULL(S.RCVQTY3,0.000)) AS RCVQTY3,SUM(ISNULL(S.RCVVAL3,0.000)) AS RCVVAL3,SUM(ISNULL(S.ISSQTY,0.000)) AS ISSQTY,SUM(ISNULL(S.ISSVAL,0.000)) AS ISSVAL,SUM(ISNULL(S.ISSQTY1,0.000)) AS ISSQTY1,SUM(ISNULL(S.ISSVAL1,0.000)) AS ISSVAL1,SUM(ISNULL(S.ISSQTY2,0.000)) AS ISSQTY2,SUM(ISNULL(S.ISSVAL2,0.000)) AS ISSVAL2,SUM(ISNULL(S.ISSQTY3,0.000)) AS ISSQTY3,SUM(ISNULL(S.ISSVAL3,0.000)) AS ISSVAL3,SUM(ISNULL(S.CLSQTY,0.00)) AS CLSQTY, SUM(ISNULL(S.CLSRATE,0.00)) CLSRATE, SUM(ISNULL(S.CLSVAL,0.00)) AS VALUE,SUM(ISNULL(S.DISPQTY,0)) AS DISPQTY  FROM STOCKSUMMARY S, INVENTORYITEMMASTER I "
            sqlstring = sqlstring & " WHERE I.ITEMCODE=S.ITEMCODE and s.storecode=i.storecode"
            If CHK_ZEROQTY.Checked = False Then
                sqlstring = sqlstring & " And (OPQTY <> 0 OR RCVQTY <> 0 OR ISSQTY <> 0)"
            End If
            sqlstring = sqlstring & " GROUP BY ISNULL(S.ITEMNAME,''),ISNULL(S.UOM,''), ISNULL(I.subgroupname,''), ISNULL(I.groupname,'')  "
            If rdo_code.Checked = True Then
                ' sqlstring = sqlstring & " I.ITEMNAME  "
            Else
                'sqlstring = sqlstring & " I.ITEMNAME "
            ...
            If gdataset.Tables("ISSUEREGISTER").Rows.Count > 0 Then
                ...
                textobj6.Text = Trim(txt_Mainstore.Text)
    ...
    Private Sub ABC_crystal()
        Try
            ...
            If Chklist_Itemdetails.CheckedItems.Count = 0 And TXT_FROM.Text <> "" And txt_itemto.Text <> "" Then
                ...
                gconnection.dataOperation(6, sqlstring, "ItemMaster")
                sqlstring = "Update inventoryitemmaster set selectopt='Y' WHERE ITEMCODE BETWEEN '" & Trim(TXT_FROM.Text) & "' AND '" & Trim(txt_itemto.Text) & "' AND STORECODE='" & Trim(TXT_MAINSTORECODE.Text) & "'"
                gconnection.dataOperation(6, sqlstring, "ItemMaster")
            Else
                SLSTRING = ""
                For i = 0 To Chklist_Itemdetails.CheckedItems.Count - 1
    ...
    Private Sub Item_master_stock_crystal()
        Try
            ...
            Storecode = "" : Clsquantity = "" : i = 0
            Dim SLSTRING As String
            Dim Heading() As String = {"ITEM MASTER STOCK SUMMARY(STORES)"}
            Storecode = Trim(TXT_MAINSTORECODE.Text)
            ...
            If MsgBox("Click 'YES' for Windows View or 'NO' for Text View", MsgBoxStyle.YesNo, "Issue Register") = MsgBoxResult.No Then
                Dim ObjStockIssuesummary As New RptItemmasterstk
        ...
        End Try
    End Sub
    Private Sub Item_master_stock_crystal1()
        Try
            Dim str, MTYPE(), tspilt() As String
            Dim i As Integer
            'Dim Heading(0) As String
            ...
            If CHK_ZEROQTY.Checked = False Then
                sqlstring = sqlstring & " And (OPQTY <> 0 OR RCVQTY <> 0 OR ISSQTY <> 0)"
            End If
            sqlstring = sqlstring & " GROUP BY S.ITEMCODE,S.ITEMNAME,ISNULL(S.UOM,''), ISNULL(I.GROUPNAME,'') ORDER BY  "
    ...
    Private Sub Select_AllComp_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Select_AllComp.CheckedChanged
        Dim i As Integer
        If Select_AllComp.Checked = True Then
            For i = 0 To Chklist_Company.Items.Count - 1
                Chklist_Company.SetItemChecked(i, True)
            Next
            'Call Chklist_SubGroup_SelectedIndexChanged(sender, e)
        Else
            For i = 0 To Chklist_Company.Items.Count - 1
                Chklist_Company.SetItemChecked(i, False)
            Next
