...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Chk_Running As System.Windows.Forms.CheckBox
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.components = New System.ComponentModel.Container
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(dailyisueDetails))
        ...
        Me.Chk_Running = New System.Windows.Forms.CheckBox
        ...
        Me.lbl_Heading.Size = New System.Drawing.Size(392, 31)
        Me.lbl_Heading.TabIndex = 9
        Me.lbl_Heading.Text = "DAILY CONSUMPTION REPORT"
        ...
        Me.chklst_Store.Size = New System.Drawing.Size(312, 361)
        ...
        Me.chk_SelectAllGroup.Location = New System.Drawing.Point(368, 80)
        ...
        Me.chklist_groupdesc.Location = New System.Drawing.Point(368, 120)
        Me.chklist_groupdesc.Name = "chklist_groupdesc"
        Me.chklist_groupdesc.Size = New System.Drawing.Size(296, 361)
        ...
        Me.Chk_SelectAllItem.Location = New System.Drawing.Point(680, 80)
        ...
        Me.lbl_Itemlist.Location = New System.Drawing.Point(680, 96)
        Me.lbl_Itemlist.Name = "lbl_Itemlist"
        Me.lbl_Itemlist.Size = New System.Drawing.Size(264, 24)
        ...
        Me.chklist_itemdetails.Location = New System.Drawing.Point(680, 120)
        Me.chklist_itemdetails.Name = "chklist_itemdetails"
        Me.chklist_itemdetails.Size = New System.Drawing.Size(264, 361)
        ...
        'CHK_GROUP
        '
        Me.CHK_GROUP.BackColor = System.Drawing.Color.Transparent
        Me.CHK_GROUP.Font = New System.Drawing.Font("Verdana", 12.0!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.CHK_GROUP.Location = New System.Drawing.Point(880, 498)
        Me.CHK_GROUP.Name = "CHK_GROUP"
        Me.CHK_GROUP.Size = New System.Drawing.Size(96, 24)
        Me.CHK_GROUP.TabIndex = 482
        Me.CHK_GROUP.Text = "GROUP WISE"
        '
        'Chk_Running
        '
        Me.Chk_Running.BackColor = System.Drawing.Color.Transparent
        Me.Chk_Running.Location = New System.Drawing.Point(880, 536)
        Me.Chk_Running.Name = "Chk_Running"
        Me.Chk_Running.TabIndex = 483
        Me.Chk_Running.Text = "Running Item"
        '
        'dailyisueDetails
        '
        ...
        Me.ControlBox = False
        Me.Controls.Add(Me.Chk_Running)
...
#End Region
    ...
    Private Sub Timer1_Tick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        Else
            ...
            If CHK_GROUP.Checked = True Then
                Call ViewIssuedetailsgroup()
            ElseIf Chk_Running.Checked = True Then
                Call ViewStockRunning()
            Else
    ...
    Public Sub ViewStockRunning()
        Try
            ...
            Sqlstring = " SELECT ISNULL(STORECODE,'') AS STORECODE FROM STOREMASTER WHERE STORECODE = '" & Mid(Trim(cbo_Storelocation.Text), 1, 3) & "'"
            ...
            Else
                ...
                Sqlstring = " update INVENTORYITEMMASTER SET SELECTOPT='N' WHERE ITEMCODE NOT IN(SELECT DISTINCT ITEMCODE FROM Running_Item WHERE GRNDATE BETWEEN '" & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "' and '" & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "' ) and storecode='" & Storecode & "'"
                gconnection.getDataSet(Sqlstring, "ITEMMASTER1")

                Sqlstring = " update INVENTORYITEMMASTER SET SELECTOPT='Y' WHERE ITEMCODE IN(SELECT DISTINCT ITEMCODE FROM Running_Item WHERE GRNDATE BETWEEN '" & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "' and '" & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "' ) and storecode='" & Storecode & "'"
            ...
            Sqlstring = " SELECT DISTINCT S.ITEMCODE,I.ITEMNAME,OPQTY FROM STOCKSUMMARY S,INVENTORYITEMMASTER I"
            Sqlstring = Sqlstring & " WHERE I.STORECODE = S.STORECODE AND I.ITEMCODE = S.ITEMCODE AND I.ITEMCODE IN(" & SLSTRING & ") ORDER BY S.ITEMCODE"
            Dim heading() As String = {"Running Item Register"}
            Dim ObjStockIssueregisterReport As New rptDailyIssueregister
            ObjStockIssueregisterReport.Reportdetails_Run(Sqlstring, heading, dtp_Fromdate.Value, dtp_Todate.Value)
    ...
    Private Sub ViewIssuedetails()
        Try
            ...
            Dim i As Integer
            '''****************************** $ ISSUE REGISTER [PCS ] $ *************************************'''
            sqlstring = " SELECT ITEMCODE,ITEMNAME,UOM,SUM(ISSQTY) AS ISSQTY,SUM(RETURNQTY) AS RETURNQTY,(SUM(AMOUNT)/SUM(ISSQTY+RETURNQTY)) AS RATE,SUM(AMOUNT) AS AMOUNT FROM INV_DAILYCONSUMPTION"
            If chklst_Store.CheckedItems.Count <> 0 Then
            ...
            sqlstring = sqlstring & " GROUP BY ITEMCODE,ITEMNAME,UOM ORDER BY ITEMCODE"
            ...
            If MsgBox("Click 'YES' to Windows view or 'NO' to Text view", MsgBoxStyle.YesNo, "Issue Details") = MsgBoxResult.Yes Then
                ...
                End If
            Else
                Dim heading() As String = {"DAILY ISSUE REGISTER"}
                Dim ObjStockIssueregisterReport As New rptDailyIssueregister
        ...
        End Try
    End Sub
    Private Sub ViewIssuedetailsgroup()
        Try
            Dim sqlstring, STORENAME() As String
            Dim Clsquantity, Itemcode(), Itemcode1, Update(0), Storecode As String
            Dim i As Integer
            '''****************************** $ ISSUE REGISTER [PCS ] $ *************************************'''
            sqlstring = " SELECT locationname,groupdesc,ITEMCODE,ITEMNAME,UOM,SUM(ISSQTY) AS ISSQTY,SUM(RETURNQTY) AS RETURNQTY,(SUM(AMOUNT)/SUM(ISSQTY+RETURNQTY)) AS RATE,SUM(AMOUNT) AS AMOUNT FROM INV_DAILYCONSUMPTION"
            If chklst_Store.CheckedItems.Count <> 0 Then
                sqlstring = sqlstring & " WHERE LOCATIONNAME IN ("
                For i = 0 To chklst_Store.CheckedItems.Count - 1
                    sqlstring = sqlstring & " '" & Trim(chklst_Store.CheckedItems(i)) & "', "
            ...
            sqlstring = sqlstring & " '" & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "' AND ' " & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "'"
            sqlstring = sqlstring & "  AND FROMSTORENAME = '" & Trim(Mid(cbo_Storelocation.Text, 5, 12)) & "' "
            sqlstring = sqlstring & " GROUP BY ITEMCODE,ITEMNAME,UOM,locationname,groupdesc  order by locationname,groupdesc,itemcode"
            ...
            Else
                Dim heading() As String = {"DAILY ISSUE REGISTER"}
                Dim ObjStockIssueregisterReport1 As New rptgroupwiseconsumption
                ObjStockIssueregisterReport1.Reportdetails(sqlstring, heading, dtp_Fromdate.Value, dtp_Todate.Value)
            End If
            '------------ITEMWISE REPORT-------------------------
            '''****************************** $ ISSUE REGISTER [PCS ] $ *************************************'''
        Catch ex As Exception
