...
Public Class Rpt_ExciseReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_ExciseReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_ExciseReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_ExciseReport = New Rpt_ExciseReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
