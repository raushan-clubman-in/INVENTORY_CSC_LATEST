...
Public Class Rpt_FOC_Itemwise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_FOC_Itemwise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_FOC_Itemwise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_FOC_Itemwise = New Rpt_FOC_Itemwise()
        rpt.Site = Me.Site
        Return rpt
    End Function
