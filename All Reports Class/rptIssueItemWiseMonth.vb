...
Imports System.io
Public Class rptIssueItemWiseMonth
            ...
            If gdataset.Tables("ISSUESUMMARYREPORT").Rows.Count > 0 Then
                ...
                For Each dr In gdataset.Tables("ISSUESUMMARYREPORT").Rows
                    ...
                    If ITEMCODE <> Trim(CStr(dr("ITEMCODE"))) Then
                        ...
                        Filewrite.Write("{0,12}", Mid(Format(Val(dr("AMOUNT") / Val(dr("QTY"))), "0.00"), 1, 12))
                ...
                Filewrite.WriteLine("{0,32}{1,12}{2,24}{3,12}", "GRAND TOTAL =======>        ", Format(TGROUPQty, "0.000"), "", Format(Tgroupvalue, "0.00"))
                pagesize = pagesize + 1
                Filewrite.WriteLine(StrDup(80, "="))
                pagesize = pagesize + 1
            Else
    ...
    Private Function PrintHeader(ByVal Heading() As String, ByVal mskfromdate As Date, ByVal msktodate As Date)
        ...
        Try
            ...
            Filewrite.WriteLine(StrDup(80, "-"))
            pagesize = pagesize + 1
            Filewrite.WriteLine("{0,-8}{1,-24}{2,12}{3,12}{4,12}{5,12}", "ITEM", "ITEM", "ISSUE", "RATE", "", "ISSUE")
            pagesize = pagesize + 1
            Filewrite.WriteLine("{0,-8}{1,-24}{2,12}{3,12}{4,12}{5,12}", "CODE", "DESCRIPTION", "QTY", "", "", "AMOUNT")
            pagesize = pagesize + 1
            Filewrite.WriteLine(StrDup(80, "-"))
            pagesize = pagesize + 1
        Catch ex As Exception
