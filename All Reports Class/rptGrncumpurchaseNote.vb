...
Public Class rptGrncumpurchaseNote
    ...
    Public Function ReportDetails_sc(ByVal SQLSTRING As String, ByVal PAGEHEAD() As String, ByVal FROMNO As String, ByVal TONO As String)
        ...
        Try
            ...
            If Mid(MyCompanyName, 1, 3) <> "HIN" Then
                ...
                STR = "PO DATE : " & gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("GRNDATE")
            Else
                STR = ""
            End If
            ...
            If gdataset.Tables("GRNPURCHASEBILL").Rows.Count > 0 Then
                ...
                If Mid(MyCompanyName, 1, 4) <> "HIND" Then
                    ...
                    If gdataset.Tables("GRNPURCHASEBILL").Rows(0).Item("UPDFOOTER") <> "" Then
    ...
    Public Function ReportDetails_sc_GST(ByVal SQLSTRING As String, ByVal PAGEHEAD() As String, ByVal FROMNO As String, ByVal TONO As String, ByVal DocDate As Date)
        Dim DBLDOCTOTAL, DBLGROUPTOTAL, DBLGRANDTOTAL As Double
        Dim dbltaxamount, SGST, CGST, IGST As Double
        Dim STROEDESC, DOCDETAILS, STR As String
        Dim STOREBOOL, DOCBOOL As Boolean
        Dim I, J, K, CC, ItemCnt As Integer
        Try

            Dim TaType As String = TaxType("GRN", Trim(FROMNO), Format(CDate(DocDate), "dd/MMM/yyyy"))
            ...
            If TaType = "VAT" Then
                ...
                Filewrite.WriteLine(StrDup(90, "-"))
                pagesize = pagesize + 1
                Filewrite.WriteLine("SNO CODE   ITEM NAME                 UOM         QTY       RATE  DISC%  TAX %      AMOUNT")
                pagesize = pagesize + 1
                Filewrite.WriteLine(StrDup(90, "-"))
                pagesize = pagesize + 1
                Dim DISCOUNT As Integer
            ...
            Else
                ...
                Filewrite.Write(Chr(18))
                'Filewrite.WriteLine(Space(60) & "BILL NO : " & gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("SUPPLIERINVNO"))
                'Filewrite.WriteLine(Space(60))
                pagesize = pagesize + 1
                Filewrite.WriteLine("CODE : " & Mid(Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("SUPPLIERCODE"))), 1, 40) & Space(40 - Len(Mid(Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("SUPPLIERCODE"))), 1, 40))) & Space(12) & "GRN DATE: " & Format(CDate(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("GRNDATE")), "dd/MM/yyyy"))
                pagesize = pagesize + 1
                'Filewrite.WriteLine("NAME : " & Mid(Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("SUPPLIERNAME"))), 1, 40) & Space(40 - Len(Mid(Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("SUPPLIERNAME"))), 1, 40))) & Space(13) & "GRN DATE: " & Mid(Format(CDate(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("GRNDATE")), "dd/MM/yyyy"), 1, 12))
                Filewrite.WriteLine("NAME : " & Mid(Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("SUPPLIERNAME"))), 1, 40) & Space(40 - Len(Mid(Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("SUPPLIERNAME"))), 1, 40))) & Space(13) & "BILL NO : " & Mid(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("SUPPLIERINVNO"), 1, 12))
                pagesize = pagesize + 1
                Filewrite.WriteLine("Addr.: " & Mid(Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("address1"))), 1, 15) & Space(15 - Len(Mid(Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("address1"))), 1, 15))) & " City : " & Mid(Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("city"))), 1, 15) & Space(15 - Len(Mid(Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("city"))), 1, 15))) & Space(15) & "Inventory : " & gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("GLACCOUNTNAME"))
                pagesize = pagesize + 1
                Filewrite.WriteLine("State: " & Mid(Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("state"))), 1, 15) & Space(15 - Len(Mid(Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("state"))), 1, 15))) & " GSTIN NO : " & Mid(Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("GSTINNO"))), 1, 15) & Space(15 - Len(Mid(Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("GSTINNO"))), 1, 15))) & Space(11) & "GL AC     : " & gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("GLACCOUNTCODE") & Chr(27) & "F")
                pagesize = pagesize + 1
                Filewrite.WriteLine(StrDup(98, "-"))
                pagesize = pagesize + 1
                Filewrite.WriteLine("SNO CODE   HSNNO  ITEM NAME                 UOM         QTY       RATE  DISC%  TAX %      AMOUNT")
                pagesize = pagesize + 1
                Filewrite.WriteLine(StrDup(98, "-"))
                pagesize = pagesize + 1
                Dim DISCOUNT As Integer
                If gdataset.Tables("GRNPURCHASEBILL").Rows.Count > 0 Then
                    ...
                    For K = 0 To gdataset.Tables("GRNPURCHASEBILL").Rows.Count - 1
                        Filewrite.Write(Space(3 - Len(Trim(Mid(CStr(K + 1), 1, 3)))) & Trim(Mid(CStr(K + 1), 1, 3)))
                        Filewrite.Write(Space(1) & Mid(Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("ITEMCODE"))), 1, 6) & Space(6 - Len(Mid(Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("ITEMCODE"))), 1, 6))))
                        Filewrite.Write(Space(1) & Mid(Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("HSNNO"))), 1, 6) & Space(6 - Len(Mid(Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("HSNNO"))), 1, 6))))
                        Filewrite.Write(Space(1) & Mid(Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("ITEMNAME"))), 1, 25) & Space(25 - Len(Mid(Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("ITEMNAME"))), 1, 25))))
                        Filewrite.Write(Space(1) & Mid(Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("UOM"))), 1, 5) & Space(5 - Len(Mid(Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("UOM"))), 1, 5))))
                        Filewrite.Write(Space(1) & Space(10 - Len(Mid(Format(Val(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("QTY")), "0.000"), 1, 10))) & Mid(Format(Val(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("QTY")), "0.000"), 1, 10))
                        Filewrite.Write(Space(1) & Space(10 - Len(Mid(Format(Val(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("RATE")), "0.00"), 1, 10))) & Mid(Format(Val(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("RATE")), "0.00"), 1, 10))
                        ...
                        DBLDOCTOTAL = DBLDOCTOTAL + Format(Val(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("AMOUNT")), "##,##0.00")
                        dbltaxamount = dbltaxamount + Format(Val(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("TAXAMOUNT")), "##,##0.00")
                        IGST = IGST + Format(Val(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("IGSTAMT")), "##,##0.00")
                        SGST = SGST + Format(Val(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("SGSTAMT")), "##,##0.00")
                        CGST = CGST + Format(Val(gdataset.Tables("GRNPURCHASEBILL").Rows(K).Item("CGSTAMT")), "##,##0.00")
                        ItemCnt = ItemCnt + 1
                    Next K
                    CC = 0
                    If dbltaxamount <= 0 Then
                    ...
                    If Val(gdataset.Tables("GRNPURCHASEBILL").Rows(0).Item("TOTALAMOUNT")) <> 0 Then
                        CC = CC + 1
                        Filewrite.WriteLine(Space(62) & " GROSS AMOUNT      " & Space(15 - Len(Trim(Mid(Format(Val(gdataset.Tables("GRNPURCHASEBILL").Rows(0).Item("TOTALAMOUNT")), "##,##0.00"), 1, 15)))) & Trim(Mid(Format(Val(gdataset.Tables("GRNPURCHASEBILL").Rows(0).Item("TOTALAMOUNT")), "##,##0.00"), 1, 15)))
                        pagesize = pagesize + 1
                    End If

                    If IGST <> 0 Or SGST <> 0 Then
                        If Trim(CStr(gdataset.Tables("GRNPURCHASEBILL").Rows(0).Item("GSTINNO"))) = "" Then
                            CC = CC + 1
                            Filewrite.WriteLine(" TAX LIBILTY      " & Space(15 - Len(Trim(Mid(Format(dbltaxamount, "0.00"), 1, 15)))) & Trim(Mid(Format(dbltaxamount, "##,##0.00"), 1, 15)))
                            pagesize = pagesize + 1
                        Else
                            If IGST <> 0 Then
                                CC = CC + 1
                                Filewrite.WriteLine(Space(62) & " IGST AMOUNT      " & Space(15 - Len(Trim(Mid(Format(IGST, "0.00"), 1, 15)))) & Trim(Mid(Format(IGST, "##,##0.00"), 1, 15)))
                                pagesize = pagesize + 1
                            Else
                                CC = CC + 1
                                Filewrite.WriteLine(Space(62) & " SGST AMOUNT      " & Space(15 - Len(Trim(Mid(Format(SGST, "0.00"), 1, 15)))) & Trim(Mid(Format(SGST, "##,##0.00"), 1, 15)))
                                pagesize = pagesize + 1
                                CC = CC + 1
                                Filewrite.WriteLine(Space(62) & " CGST AMOUNT      " & Space(15 - Len(Trim(Mid(Format(CGST, "0.00"), 1, 15)))) & Trim(Mid(Format(CGST, "##,##0.00"), 1, 15)))
                                pagesize = pagesize + 1
                            End If
                    ...
                    Else
                            CC = CC + 1
                        Filewrite.WriteLine(Space(62) & " VAT AMOUNT       " & Space(15 - Len(Trim(Mid(Format(dbltaxamount, "0.00"), 1, 15)))) & Trim(Mid(Format(dbltaxamount, "##,##0.00"), 1, 15)))
                            pagesize = pagesize + 1
                    End If
                    If Val(gdataset.Tables("GRNPURCHASEBILL").Rows(0).Item("SURCHARGEAMT")) <> 0 Then
                        CC = CC + 1
                        Filewrite.WriteLine(Space(62) & " OTHER AMOUNT  " & Space(15 - Len(Trim(Mid(Format(Val(gdataset.Tables("GRNPURCHASEBILL").Rows(0).Item("SURCHARGEAMT")), "##,##0.00"), 1, 15)))) & Trim(Mid(Format(Val(gdataset.Tables("GRNPURCHASEBILL").Rows(0).Item("SURCHARGEAMT")), "##,##0.00"), 1, 15)))
                        pagesize = pagesize + 1
                    End If
                    If Val(gdataset.Tables("GRNPURCHASEBILL").Rows(0).Item("DISCOUNT")) <> 0 Then
                        CC = CC + 1
                        Filewrite.WriteLine(Space(62) & " DISCOUNT AMOUNT   " & Space(15 - Len(Trim(Mid(Format(Val(gdataset.Tables("GRNPURCHASEBILL").Rows(0).Item("DISCOUNT")), "##,##0.00"), 1, 15)))) & Trim(Mid(Format(Val(gdataset.Tables("GRNPURCHASEBILL").Rows(0).Item("DISCOUNT")), "##,##0.00"), 1, 15)))
                        pagesize = pagesize + 1
                    End If
                    If Val(gdataset.Tables("GRNPURCHASEBILL").Rows(0).Item("OverallDISCOUNT")) <> 0 Then
                        CC = CC + 1
                        Filewrite.WriteLine(Space(62) & " OVERALL DISCOUNT  " & Space(15 - Len(Trim(Mid(Format(Val(gdataset.Tables("GRNPURCHASEBILL").Rows(0).Item("OverallDISCOUNT")), "##,##0.00"), 1, 15)))) & Trim(Mid(Format(Val(gdataset.Tables("GRNPURCHASEBILL").Rows(0).Item("OverallDISCOUNT")), "##,##0.00"), 1, 15)))
                        pagesize = pagesize + 1
                    End If
                    If CC > 0 Then
                        Filewrite.WriteLine(Space(62) & " BILL AMOUNT       " & Space(15 - Len(Trim(Mid(Format(Val(gdataset.Tables("GRNPURCHASEBILL").Rows(0).Item("BILLAMOUNT")), "##,##0.00"), 1, 15)))) & Trim(Mid(Format(Val(gdataset.Tables("GRNPURCHASEBILL").Rows(0).Item("BILLAMOUNT")), "##,##0.00"), 1, 15)))
                        pagesize = pagesize + 1
                    End If
                    '    Filewrite.WriteLine(Space(62) & Space(15 - Len(Trim(Mid(Format(Val(DBLDOCTOTAL), "0.00"), 1, 15)))) & Trim(Mid(Format(Val(DBLDOCTOTAL), "0.00"), 1, 15)))
                    Filewrite.WriteLine(StrDup(98, "-"))
